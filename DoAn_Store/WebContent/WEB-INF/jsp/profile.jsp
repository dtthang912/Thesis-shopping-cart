			...
			<div class="row">
				...
				<div class="span9">
					<ul class="breadcrumb">
						...
						<li class="active"><spring:message code="edit.profile.title" /></li>
					</ul>
					<h3>
						<spring:message code="edit.profile.title" />
					</h3>
					<hr class="soft" />
					...
					<div class="well">
						<div class="row">
							<form:form cssClass="offset1 form-horizontal" method="post"
								action="profile" modelAttribute="customerForm">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="fName"
											path="fName" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="mName"
											path="mName" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="lName"
											path="lName" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="city" path="city" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="phone"
											path="phone" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<form:input required="true" cssClass="span3" type="text" id="email"
											path="email" />
									</div>
								</div>
								<div class="control-group">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<a href="contact.html"><spring:message
							code="contact.strong.title" /></a> <a href="register.html"><spring:message
