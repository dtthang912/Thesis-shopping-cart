			...
			<div class="top-10">
				<div class="col-md-11">
					<table class="table table-hover table-striped">
						...
						<tbody>
							<c:forEach var="customer" items="${customerForm.customerList}"
								varStatus="status">
								<tr>
									...
									<td>
										<div class="form-group">
											<form:input type="text"
												...
												input-sm"
												path="customerList[${status.index}].fName" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].mName" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].lName" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].num" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].street" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].distric" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].city" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].phone" required="true" />
										</div>
									</td>
									<td>
										<div class="form-group">
											<form:input type="text" cssClass="form-control input-sm"
												path="customerList[${status.index}].email" required="true" />
										</div>
									</td>
