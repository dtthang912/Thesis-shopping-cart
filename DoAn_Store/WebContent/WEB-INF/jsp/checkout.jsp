			...
			<div class="row">
				...
				<div class="span9">
					<ul class="breadcrumb">
						...
						<li class="active"><spring:message code="checkout.title" /></li>
					</ul>
					<h3>
						<spring:message code="checkout.title" />
					</h3>
					<hr class="soft" />
						...
						<div class="span9">
							<div class="well">
								<form:form cssClass="offset1 form-horizontal" method="post"
									action="checkout" modelAttribute="deliveryForm">
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:input required="true" cssClass="span3" type="text" id="num" path="num" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<form:input required="true" cssClass="span3" type="text" id="street"
												path="street" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<form:input required="true" cssClass="span3" type="text" id="distric"
												path="distric" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<form:input required="true" cssClass="span3" type="text" id="city"
												path="city" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="additionalAddressInfo"><spring:message
												code="additional.info.title" /></label>
										<div class="controls">
											<form:input cssClass="span3" type="text"
												id="additionalAddressInfo" path="additionalAddressInfo" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="contactNumber"><spring:message
												code="contact.number.title" /></label>
										<div class="controls">
											<form:input required="true" cssClass="span3" type="text" id="contactNumber"
												path="contactNumber" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="paymentType"><spring:message
												code="payment.method.title" /></label>
										<div class="controls">
											<form:select id="paymentType" path="paymentType">
												<option value="CASH"><spring:message
														code="cash.title" /></option>
												<option value="CREDIT_CARD"><spring:message
														code="credit.card.title" /></option>
											</form:select>
										</div>
									</div>
									<div class="control-group">
										<div class="controls">
											<spring:message code="order.success.title" var="successTitle" />
											<form:button type="submit" class="btn order-btn"
												data-alert="${successTitle}">
