	...
	<div id="mainBody">
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					<ul class="breadcrumb">
						<li><a href="${appPath}/index"><spring:message code="homepage.title"/></a> <span class="divider">/</span></li>
						<li class="active"><spring:message code="login.title"/></li>
					</ul>
					...
					<div class="row">
						<div class="span9">
							<div class="well">
								<form:form cssClass="offset3" method="post" action="login"
									...
									<br>
									<div class="control-group">
										<label class="control-label" for="username"><spring:message code="login.label.username"/></label>
										<div class="controls">
											<form:input cssClass="span3" type="text" id="username"
												placeholder="Username" path="userName" />
										</div>
									...
									<div class="control-group">
										<label class="control-label" for="pass"><spring:message code="login.label.password"/></label>
										<div class="controls">
											<form:input cssClass="span3" type="password" id="pass"
												placeholder="Password" path="pass" />
										</div>
									...
									<div class="control-group">
										<div class="controls">
											<form:button type="submit" class="btn"><spring:message code="login.button.login"/></form:button>
											<a href="${appPath}/register"><spring:message code="register.label"/></a>
										</div>
									</div>
								</form:form>
							</div>
